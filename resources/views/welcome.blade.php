...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-8">
    ...
    <div class="bg-white p-5 rounded shadow-lg">
        ...
        <div class="flex space-x-8 mt-5">
            <button onclick="toggleModal({{$item->id}})" class="bg-blue-500 text-white px-4 py-2 rounded">Moderatorlar
                ro'yxati</button>
            ...
            <div class="modal">
                <div class="md:flex">
                    ...
                    <ul
                        ...
                        <!-- Tab link -->
                        <li>
                            <a href="#" onclick="openCity(event, 'Moderator{{$moderator->id}}')" id="defaultOpen"
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <button id="close-modal" onclick="document.getElementById('notification-modal').style.display='none'"
