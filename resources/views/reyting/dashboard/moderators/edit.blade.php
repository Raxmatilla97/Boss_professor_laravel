        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('moderator.update', ['moderator' => $moderator]) }}" method="POST"
                        ...
                        <img id="image-preview" class="rounded-full"
                            src="/uploads/moderator_images/{{ $moderator->moder_image }}" alt="{{ $moderator->moder_fish }}">
                        <style>
                            #image-preview {
                                width: 150px;
                                height: 150px;
                        ...
                        <div class="mb-5">
                            <label for="moder_fish" class="block text-gray-600">Moderator
                                F.I.SH:</label>
                            <input type="text" name="moder_fish" value="{{ old('moder_fish', $moderator->moder_fish) }}"
                        ...
                        <div class="mb-4">
                            <label for="moder_small_info" class="block text-gray-600">Moderator mavzusi
                                haqida:</label>
                            <textarea name="moder_small_info" id="moder_small_info" class="border px-4 py-2 w-full"
                                rows="4">{{ old('moder_small_info', $moderator->moder_small_info) }}</textarea>
                        ...
                        <div class="mb-4">
                            <label for="moder_small_info2" class="block text-gray-600">Moderator mavzusi muommolari
                                haqida:</label>
                            <textarea name="moder_small_info2" id="moder_small_info2" class="border px-4 py-2 w-full"
                                rows="4">{{ old('moder_small_info2', $moderator->moder_small_info2) }}</textarea>
                        ...
                        <div class="mb-4 mt-6 text-right flex justify-between">
                            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" type="button"
                                class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-small rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">O'chirish</button>
                            <button type="submit" class="bg-blue-500 text-white py-2 px-4">Moderatorni
                                tahrirlash</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form action="{{ route('moderator.destroy', $moderator->id )}}" method="post">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Moderatorni o'chirishni
                            istaysizmi?
                            <p class="mt-3 text-sm">Agarda moderatorni o'chirsangiz unga tegishli operatorlarham o'chib
                                ketadi!</p>
                        </h3>
