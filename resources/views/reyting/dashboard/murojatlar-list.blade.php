                                ...
                                <div class="relative">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <select id="default" name="sort" style="width: 200px;"
                                            ...
                                            <option selected>Vaqt bo'yicha saralash</option>
                                            <option value="asc">Birinchi yuborilgan</option>
                                            <option value="desc">Ohirgi yuborilgan</option>
                                        ...
                                        <div date-rangepicker class="flex items-center ml-4 mr-6">
                                            <div class="relative">
                                                ...
                                                <input name="start_data" type="text"
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            <img class="hidden sm:block w-10 h-10 rounded-full"
                                                style="object-fit: cover;" src="{{ $item->surat }}" alt="">
