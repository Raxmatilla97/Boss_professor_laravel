        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="alert-additional-content-1"
                ...
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-medium">Kelib kordinatorlardan, moderatorlarda va operatorlardan kelib tushgan murojaatlar.</h3>
                </div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="{{asset('/uploads/moderator_images/qudratbek.jpg')}}" alt="Jese image">
                    <div class="ps-3">
