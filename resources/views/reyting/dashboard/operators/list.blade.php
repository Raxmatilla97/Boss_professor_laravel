        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="alert-additional-content-1"
                ...
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-medium">Yangi Operatorni faqat Kordinator tahrirlash sahifasidan qo'shasiz.</h3>
                </div>
                        ...
                        <div class="p-6 text-gray-900 mb-8">
                            <form class="mb-6" action="{{route('operator.list')}}" method="get">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="search" name="name" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Operator ism familyasini yozing..." >
                                    <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Operator qidirish</button>
                                </div>
                            </form>

                            <!-- Nested accordion -->
                            <div id="accordion-nested-collapse-1"
