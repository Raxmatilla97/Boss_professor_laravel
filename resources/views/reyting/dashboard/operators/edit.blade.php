<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __("Operator ma'lumotlarini o'zgartirish") }}
        </h2>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Operator
                    ...
                    <form action="{{ route('operator.update', ['operator' => $operator]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                {{ $operator->oper_status == 1 ? 'checked' : '' }}>
                                <div
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Operatorni o'chirishni istaysizmi? 
                        <p class="mt-3 text-sm">Agarda Operatorni o'chirsangiz uni ma'lumotlarini qaytib tiklab bo'lmaydi!</p></h3>
