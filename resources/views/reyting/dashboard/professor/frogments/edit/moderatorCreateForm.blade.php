...
<div class="py-2">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <!-- Breadcrumb -->
        <nav class="flex px-5 mb-4 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{route('professors.index')}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Professorlar ro'yxati</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                ...
                <a href="{{route('professors.edit', $professor_info['slug'] )}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Professor ma'lumotlarini tahirlash</a>
                </div>
            </li>
            <li aria-current="page">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Moderator qo'shish</span>
                </div>
            </li>
            </ol>
        </nav>
