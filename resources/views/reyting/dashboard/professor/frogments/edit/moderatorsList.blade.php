        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-8 ">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border">
                ...
                <tbody>
                    ...
                    @foreach ($professor_moder as $items)
                    ...
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <div style="width: 40px; height: 40px; overflow: hidden; border-radius: 50%;">
                                @if ($items->moder_image)
                                <img style="width: 100%; height: 100%; object-fit: cover;"
                                    src="/uploads/moderator_images/{{$items->moder_image}}" alt="Jese image">
                                @else
                                <img style="width: 100%; height: 100%; object-fit: cover;"
                            ...
                            <div class="ps-3">
                                <div class="text-base font-semibold">{{$items->moder_fish}}</div>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span
                                ...
                                {{ $items->custom_ball}}</span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                @if($items->moder_status)
                        ...
                        <td class="px-6 py-4">
                            <a href="{{route('moderator.edit', ['moderator_id' => $items->id])}}"
                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Tahrirlash
                            </a>
                        </td>
                    </tr>
            ...
            @else
            <div class="mb-5">
                <h1 class="text-center text-xl font-medium mb-4 mt-2 text-gray-400">Moderator yaratilmagan!</h1>
...
<script>
    ...
    const textToCopy = element.getAttribute('data-clipboard-text2');
...
<div id="toast2"
    ...
    <div class="ms-3 text-sm font-normal">Moderator ID raqami nusxalandi!</div>
