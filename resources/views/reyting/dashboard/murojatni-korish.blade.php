                        ...
                        <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                            ...
                            <ol
                                ...
                                <li class="mb-10 ms-6">
                                    ...
                                    <h3 class="font-medium leading-tight">Ma'lumotni ko'rish va tekshirib baxo qo'yish</h3>
                                    ...
                                    <div class="max-w-5xl mt-6 mx-auto  bg-white rounded-xl top-bottom-shadow overflow-hidden">
                                        <div class="p-6">
                                            <h2 class="text-2xl font-bold text-gray-800 text-center">{{ $information->fish_info }}ning Murojaati</h2>

                                            <!-- Category Item -->
                                            <div class="mt-4">
                                                <i class="fas fa-tags text-blue-500"></i>
                                                <span class="ml-2 text-lg font-medium">Yo'nalish:</span>
                                                <span class="text-lg text-gray-600">{{$information->category_name}}</span>
                                            </div>
                                            <!-- Description -->
                                            <div class="mt-4">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <a href="url_site" class="text-lg text-blue-500">url_site</a>
                                            </div>
                                            <!-- File Upload Info -->
                                            <div class="mt-4 flex items-center">
                                                <i class="fas fa-file-upload text-red-500"></i>
                                                <span class="ml-2 text-lg text-gray-600">Yuklangan Fayl (agar mavjud bo'lsa)</span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
