                                ...
                                <div class="md:space-y-2 mb-3">
                                    ...
                                    <div class="flex flex-col items-center py-6 md:flex-row md:items-start">
                                        @if ($user_info['image'] == '')
                                            <img class="mb-3 md:mb-0 md:mr-4 rounded-md object-cover md:self-start"
                                                ...
                                                alt="Avatar Upload" style="width: 150px">
                                        @else
                                            <img class="mb-3 md:mb-0 md:mr-4 rounded-md object-cover md:self-start"
                                                src="{{ $user_info['img_path'] }}/{{ $user_info['image'] }}"
                                                alt="Avatar Upload" style="width: 150px">
                                        @endif
                                    ...
                                    <div class="flex-auto w-full mb-1 text-xs space-y-2">
                                        ...
                                        <select id="countries" name="category_name"
                                            ...
                                            @foreach ($mavzular_turi as $key => $value)
                                                <option class="w-1/2" value="{{ $key }}">{{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="flex-auto w-full mb-1 text-xs space-y-2">
                                        ...
                                        <p id="helper-text-explanation"
                                            ...
                                            qo'yishdan oldin o'sha sahifa ishlayotganligiga amin bo'ling!</p>
