                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <div class="flex flex-col items-center px-4 sm:px-0 lg:flex-row lg:justify-between">
                            ...
                            <img class="rounded w-4/5 sm:w-2/4 md:w-1/3 lg:w-1/6"
                                src="{{ '/uploads/professor_images' }}/{{ $professor->image }}" alt="Extra large avatar"  style="width: 189px; height: 200px; object-fit: cover;">
                        </div>
                        ...
                        <div class="mt-6 border-t border-gray-100">
                            <dl class="divide-y divide-gray-100">
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-md font-medium leading-6 text-gray-900">Kordinatorning shaxsiy ballari
                                    </dt>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 pl-4 m-auto text-center" style="width: 90%">
                        <span
                            ...
                            Kordinator tomonidan yuklangan fayllar va ularga qo'yilgan ballar (Eng so'ngi yuklangan 5 ta
                            ma'lumot ko'rsatilmoqda!
                            Barcha ma'lumotlarni ko'rish uchun <b>"Ma'lumotlarni ko'rish"</b> tugmasiga bosing. )</span>
                    </p>
                    <div class="px-0 py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-0">
                        <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                            <ul role="list" class="divide-y divide-gray-100 rounded-md border border-gray-200">
                                @if (count($professor->files) > 0)
                                    @foreach ($professor->files->sortByDesc('created_at')->take(5) as $files_or_urls)
                                    ...
                                    <div class="flex justify-center">
                                        <a href="{{ route('showDetails.index', ['professor_id' => $professor->id]) }}">
                                            <button type="button"
                                                class="mb-8 mt-6 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ma'lumotlarni
                                                ko'rish</button>
                                        </a>
                                    </div>
                                @else
                                ...
                                <div id="accordion-color-body-{{ $item->id }}" class="hidden"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <dt class="text-md font-medium leading-6 pt-6 text-gray-900">Ilmiy yo‘nalish
                                                mavzusi
                                                nomi:
                                            </dt>
                                            <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        ...
                                        <div
                                            ...
                                            <dt class="text-md font-medium leading-6 pt-4 text-gray-900">Ilmiy yo‘nalish
                                                mavzusi
                                                muommolari:</dt>
                                            <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                            ...
                                            <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                <ul role="list"
                                                    ...
                                                    @if (count($item->files) > 0)
                                                        @foreach ($item->files->sortByDesc('created_at')->take(5) as $files_or_urls)
                                                            @include('reyting.frontend.frogments.showProfessorFiles')
                                                        @endforeach
                                                    ...
                                                    <div class="flex justify-center">
                                                        <a
                                                            href="{{ route('showDetails.index', ['moderator_id' => $item->id]) }}">
                                                            <button type="button"
                                                                class="mb-8 mt-6 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ma'lumotlarni
                                                                ko'rish</button>
                                                        </a>
                                                ...
                                                <div class="px-1 py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-0">
                                                    <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                        ...
                                                        <div class="flex justify-center mt-6">
                                                            ...
                                                            <p class="mb-2  text-gray-500 dark:text-gray-400 ">
                                                            <p class="text-gray-500 text-xl mt-6 dark:text-gray-400">
                                                                Operator <b>
                                                                    <span
                                                                        class="bg-green-100 text-green-800 text-m font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">{{ $items->oper_fish }}</span></b>ga
                                                                Biriktirilgan mavzu nomi:</p>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <dt class="text-md font-medium leading-6 pt-6 text-gray-900">
                                                                Ilmiy
                                                        ...
                                                        <div
                                                            class="px-4 pt-6 pb-6 sm:grid sm:grid-cols-3 text-center w-5/6 m-auto sm:gap-2 sm:px-0">
                                                            <dt class="text-md font-medium leading-6 pt-4 text-gray-900">
                                                                Ilmiy
                                                                yo‘nalish mavzusi
                                                                muommolari:</dt>
                                                            <dd
                                                        ...
                                                        <div class="px-1 py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-0">
                                                            <dd class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                                                <ul role="list"
                                                                    ...
                                                                    @if (count($items->files) > 0)
                                                                        @foreach ($items->files->sortByDesc('created_at')->take(5) as $files_or_urls)
                                                                            @include('reyting.frontend.frogments.showProfessorFiles')
                                                                    ...
                                                                    <div class="flex justify-center">
                                                                        <a
                                                                            href="{{ route('showDetails.index', ['operator_id' => $items->id]) }}">
                                                                            <button type="button"
                                                                                class="mb-8 mt-6 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ma'lumotlarni
                                                                                ko'rish</button>
                                                                        </a>
