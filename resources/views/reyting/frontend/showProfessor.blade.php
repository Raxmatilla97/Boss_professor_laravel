                    ...
                    <div>
                        ...
                        <div class="flex flex-col items-center px-4 sm:px-0 lg:flex-row lg:justify-between">
                            <div class="mb-4 lg:mb-0">
                                <h3 class="text-base font-semibold leading-7 text-gray-900">Professor haqida ma'lumotlar</h3>
                    ...
                    <div class="p-6 text-gray-900 mb-8">
                        ...
                        <div id="accordion-color" data-accordion="collapse"
                            ...
                            <div id="accordion-nested-collapse" data-accordion="collapse"
                                    ...
                                    <button type="button"
                                        ...
                                        <tr
                                            ...
                                            <th scope="row"
                                                ...
                                                <div class="ps-3">
                                                    <div class="text-base font-semibold">Fayziyev
                                                        Raxmatilla Xanshor o'g'li</div>
                                                    <div class="font-normal text-gray-500">3JHlo3J54oO!ool
                                                    </div>
                                                </div>
                                            </th>
                                            <td class="px-6 py-4">
                                ...
                                <div id="accordion-nested-collapse-body-{{ $item->id }}" class="hidden mb-5"
                                    aria-labelledby="accordion-nested-collapse-heading-{{ $item->id }}">
                                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                                        <p class="text-gray-500 dark:text-gray-400">
                                        <blockquote
                                            class="p-4 my-4 border-s-4 text-sm border-gray-300 bg-gray-50 dark:border-gray-500 dark:bg-gray-800">
                                            <b>Mavzu:</b> Lorem ipsum dolor sit amet consectetur adipisicing
                                            elit. Quod fugit cumque beatae nisi! Inventore omnis, quae
                                            mollitia nemo dolore iusto quibusdam. Aspernatur dolore quasi
